...
using Alloy.Multisite.Models.Blocks;
...
namespace Alloy.Multisite.Models.Pages
{
    ...
    public class StartPage : SitePageData
    {
        ...
        [SelectOne(SelectionFactoryType = typeof(Business.SelectionFactories.LayoutSelector))]
        [Display(GroupName = Global.GroupNames.SiteSettings, Order = 200)]
